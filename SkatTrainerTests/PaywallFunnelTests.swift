...
final class PaywallFunnelTests: XCTestCase {
    ...
    func testCountsPitchesPerSurfaceAndInTotal() {
        ConversionDiagnostics.recordPitchView(impressionID: "skat_onboarding_trial")
        ConversionDiagnostics.recordPitchView(impressionID: "skat_onboarding_trial")
        ConversionDiagnostics.recordPitchView(impressionID: "skat_paywall_sheet")
    ...
    func testAttributeKeysStayInsideRevenueCatsLimit() {
        ...
        ConversionDiagnostics.recordPitchView(impressionID: "skat_\(long)")
