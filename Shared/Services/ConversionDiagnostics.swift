...
/// On-device record of how someone met Skat+ before they bought it: which
...
enum ConversionDiagnostics {
    private static let logger = Logger(subsystem: "com.jackwallner.skat", category: "Conversion")
    ...
    private static let impressionPrefix = "skat_"
